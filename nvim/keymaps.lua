...
vim.keymap.set("n", "<leader>fc", builtin.current_buffer_fuzzy_find, { desc = "Telescope keymaps" })
vim.keymap.set("n", "<leader>ft", builtin.current_buffer_tags, { desc = "Telescope keymaps" })
